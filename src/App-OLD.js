...
class PhenotypeSelect extends Component {
    constructor(props) {
        super(props);
        ...
        if (this.canRun()) {
            this.setState(
                ...
                () => {
                    ...
                    axios
                        .post(
                            this.default_claritynlpaas_url + normalized_task,
                            {
                                reports: docs
                            },
                            {
            ...
            this.setState(
                {
                    patient: p["id"],
                    patient_name:
                        this.prettify(last_name, true) +
                        ", " +
                        this.prettify(first_name, true)
                },
                () => {
    ...
    componentDidMount() {
        this.modeToggle();
        axios
            .get(this.default_claritynlpaas_url + "list/all")
            .then(response => {
    ...
    render() {
        ...
        for (let [k, values] of this.state.items_map) {
            ...
            items.push(
                <DropdownItem header key={"header" + k}>
                    <b>{this.prettify(k, true)}</b>
                </DropdownItem>
            );
            for (let v in values) {
        ...
        let result_items = this.state.results.map((r, it) => {
            ...
            let row_values = column_keys.map((c, rit) => {
                if (r.hasOwnProperty(c)) {
                    ...
                    return (
                        <td key={id + "." + rit} className={className}>
                            {row_value}
                        </td>
                    );
                } else {
            ...
            return <tr key={"row" + id}>{row_values}</tr>;
        });
        ...
        return (
            <div className="App">
                <Navbar
                    expand="md"
                    className="App-header light bg-info"
                    style={{ height: "50px" }}
                >
                    <NavbarBrand className="mr-auto">
                        <img
                            src={logo}
                            className="App-logo hidden-sm-down"
                            alt="logo"
                        />
                            ...
                            <div className="form">
                                <FormGroup>
                                    ...
                                    <Input
                                        ...
                                        onChange={this.patientInputChanged}
                                    />
                                </FormGroup>
                            </div>
                        </div>
                            ...
                            <div className="form">
                                <FormGroup>
                                    ...
                                    <Dropdown
                                        ...
                                        isOpen={this.state.task_dropdown_open}
                ...
                <Modal
                    isOpen={this.state.result_modal}
